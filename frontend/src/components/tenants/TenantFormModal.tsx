        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <Field label="Email" required>
            <input
              ...
              required
              disabled={isEdit}
              className="mt-1 w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500/30 focus:border-brand-500 disabled:bg-gray-100"
            />
          </Field>
        </div>
          ...
          <div className="rounded-md border border-gray-200 bg-gray-50 p-4">
            ...
            <div className="mt-3">
              <select
                ...
                className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-brand-500/30 focus:border-brand-500"
              >
                <option value="">
                  {unitsLoading
